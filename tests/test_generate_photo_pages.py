...
class StaticPhotoPagesTest(unittest.TestCase):
    ...
    def test_recent_gallery_promotes_one_editorial_collection_after_sixty_photos(self):
        ...
        self.assertIn("TEMPORARY_CAMPAIGNS", script)
        self.assertIn("murales-verano-2026", script)
        self.assertIn("arte-en-los-muros", script)
        self.assertIn("Descubre y captura los murales de la ciudad", script)
        self.assertIn("endsAt: '2026-08-10T23:59:59+02:00'", script)
        self.assertIn("currentPhotos[5].after", script)
        ...
        self.assertIn(".temporary-campaign-promo", styles)
